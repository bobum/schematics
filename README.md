...
1. **User Registration Form with Input Validation** (Python)
2. **User Preferences REST API** (Node.js)

---

# 1. User Registration Form with Input Validation
...
Contributions are welcome for both projects! Please ensure:

1. All tests pass
2. New features include tests
3. Code follows project style guidelines (PEP 8 for Python, ESLint for Node.js)
